...
def get_videos(items, api_key):
    ...
    for video in items:
        ...
        subscriber_count = prepare_feature(
            get_channel_statistics(snippet["channelId"], api_key)
        )
        ...
        line = (
            ...
            + [
                ...
                subscriber_count,
                prepare_feature(trending_date),
                tags,
                prepare_feature(view_count),
                prepare_feature(likes),
                prepare_feature(comment_count),
                prepare_feature(thumbnail_link),
                prepare_feature(comments_disabled),
                prepare_feature(ratings_disabled),
                prepare_feature(description),
            ]
        )
